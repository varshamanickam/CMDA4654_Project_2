...
In the stepwise summary, we are able to see that the model with the lowest AIC is one that contains 20 of our predictor variables. We will now use these predictors indicated from the stepAIC to form our refined model.
